<?php /// $Id: install.php,v 1.65.2.15 2009/02/14 11:03:42 stronk7 Exp $
...
?>
            ...
            <?php echo ($nextstage < SAVE) ? "<input $disabled type=\"submit\" name=\"next\" value=\"".get_string('next')."  &raquo;\" style=\"float: ".fix_align_rtl("right")."\"/>\n" : "&nbsp;\n" ?>
