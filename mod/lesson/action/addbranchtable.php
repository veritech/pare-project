<?php // $Id: addbranchtable.php,v 1.13.2.1 2007/02/23 20:12:07 mark-nielsen Exp $
/**
 *  Action for adding a branch table.  Prints an HTML form.
 *
 * @version $Id: addbranchtable.php,v 1.13.2.1 2007/02/23 20:12:07 mark-nielsen Exp $
